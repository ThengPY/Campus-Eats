...
const AiMealPlanner = ({ isOpen, onClose, cafeterias, foodItems, onAddToCart }) => {
  ...
  const generateMealPlan = () => {
    ...
    if (cafeteriaId === null) {
      console.log("Generating meal plan for all cafeterias");
      ...
      console.log("Generating meal plan for specific cafeteria:", cafeteriaId);
                      ...
                      <li>
                        ...
                        {mealPlan[cafeteriaId].food.price && (
                          <div className="right-icons" style={{ gap: "3px" }}>
                            ...
                            <span className="material-symbols-rounded" onClick={() => handleAddToCartLocal(mealPlan[cafeteriaId].food, cafeteriaId)} style={{ fontSize: "25px" }}>add</span>
                          </div>
                        )}
                      </li>
                      <li>
